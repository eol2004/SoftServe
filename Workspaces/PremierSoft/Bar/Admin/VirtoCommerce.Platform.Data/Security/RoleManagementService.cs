...
namespace VirtoCommerce.Platform.Data.Security
{
    public class RoleManagementService : ServiceBase, IRoleManagementService
    {
        ...
        public RoleManagementService(Func<IPlatformRepository> platformRepository, IPermissionScopeService permissionScopeService, ISecurityService securityService)
        {
        ...
        public void DeleteRole(string roleId)
        {
            ...
            _securityService.RemoveUsersFromCacheByRole(roleId);
        }
        ...
        public Role AddOrUpdateRole(Role role)
        {
            ...
            _securityService.RemoveUsersFromCacheByRole(sourceEntry.Id);
