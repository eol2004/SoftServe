namespace VirtoCommerce.Platform.Core.Security
{
    public static class PredefinedPermissions
    {
        ...
        public const string DynamicPropertiesQuery = "platform:dynamic_properties:read",
            ...
            DynamicPropertiesItemsUpdate = "platform:dynamic_properties:items_update";
        ...
        static PredefinedPermissions()
        {
            Permissions = new[]
            {
                ...
                new Permission
                {
                    Id = DynamicPropertiesItemsUpdate,
                    Name = "Update items dynamic property",
                    Description = "Permission to update dynamic properties data for binded items.",
                    ModuleId = "VirtoCommerce.Platform",
                    GroupName = "Настройки"
                },
                new Permission
                ...
                {
                    Id = SecurityCallApi,
                    Name = "Вызов методов Web API",
                    Description = "Разрешение на вызов методов Web API.",
                    ModuleId = "VirtoCommerce.Platform",
                    GroupName = "Web API"
                },
                new Permission
                {
                    ...
                    Name = "Управление фоновыми задачами",
                    Description = "Разрешение на просмотр и управление фоновыми задачами.",
                    ModuleId = "VirtoCommerce.Platform",
                    GroupName = "Фоновые задачи"
                },
                new Permission
                {
                    Id = AssetAccess,
