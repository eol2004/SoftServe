...
angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .controller('DateTimePickerController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$document', '$timeout', '$position', 'dateFilter', 'dateParser', 'uiDatetimePickerConfig', '$rootScope',
        function (scope, element, attrs, $compile, $parse, $document, $timeout, $position, dateFilter, dateParser, uiDatetimePickerConfig, $rootScope) {
            ...
            this.init = function(_ngModel) {
                ...
                if (attrs.datepickerOptions) {
                    ...
                    if (options && options.initDate) {
                        scope.initDate = fromTimezone(options.initDate, ngModelOptions.timezone);
                ...
                if (!isHtml5DateInput) {
                    ...
                    ngModel.$formatters.push(function(value) {
                        ...
                        scope.date = fromTimezone(value, ngModelOptions.timezone);;
            ...
            function parseDate(viewValue) {
                ...
                if (!viewValue) {
                    ...
                    if (!isNaN(date)) {
                        return toTimezone(date, ngModelOptions.timezone);
                    }
