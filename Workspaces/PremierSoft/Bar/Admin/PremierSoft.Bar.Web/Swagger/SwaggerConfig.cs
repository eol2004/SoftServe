...
namespace VirtoCommerce.Platform.Web.Swagger
{
    public static class SwaggerConfig
    {
        public static void RegisterRoutes(IUnityContainer container)
        {
            ...
            EnableSwagger("PremierSoft.Bar", httpConfiguration, container, routePrefix, xmlCommentsFilePaths, false, Assembly.GetExecutingAssembly());
            ...
            httpConfiguration.EnableSwagger(routePrefix + "docs/{apiVersion}", c =>
            {
                ...
                c.SingleApiVersion("v1", "PremierSoft REST API documentation");
            ...
            .EnableSwaggerUi(routePrefix + "docs/ui/{*assetPath}", c =>
            {
                ...
                const string resourcePrefix = "PremierSoft.Bar.Web.Swagger.UI.";
                ...
                //c.CustomAsset("css/reset-css", assembly, resourcePrefix + "reset-css");
