...
.factory('platformWebApp.dialogService', ['$rootScope', '$modal', function ($rootScope, $modal) {
    ...
    dialogService.showConfirmationDialogOkCancel = function (dialog) {
        dialogService.showDialog(dialog, '$(Platform)/Scripts/common/dialogs/confirmDialogOkCancel.tpl.html', 'platformWebApp.confirmDialogController');
    };
