...
.controller('platformWebApp.newAccountWizardController', ['$scope', 'platformWebApp.bladeNavigationService', 'platformWebApp.accounts', 'platformWebApp.roles', 'premierSoft.coreModule.company.companies',
    function ($scope, bladeNavigationService, accounts, roles, companies) {
